...
export function keepShareOnSaveError(previous: ShareState, succeeded: boolean, next?: ShareState): ShareState {
...
export function tokenAfterSave(existing: string | null, incoming: string | null): string | null {
